      ...
      <div class="ratingselect">
        <div class="rating-type">
          ...
          <span class="block positive" :class="{active: selectType===0}" @click="setSelectType(0)">
            满意<span class="count">{{satisfyingRatings}}</span>
          </span>
          <span class="block negative" :class="{active: selectType===1}" @click="setSelectType(1)">
            不满意<span class="count">{{ratings.length - satisfyingRatings}}</span>
          </span>
        </div>
        ...
        <ul>
          <li class="rating-item" v-for="(rating, index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="star-wrapper clearFixed">
...
// import dateStyle from '../../../common/date-style/GMT-toString'
export default {
  data () {
    return {
  ...
  computed: {
    ...
    filterRatings () {
      ...
      return ratings.filter((rating) => {
        ...
        return (!onlyShowText || onlyShowText === Boolean(text.length)) && (selectType === 2 || selectType === rateType)
      })
    },
    satisfyingRatings () {
      const {ratings} = this
      let arr = ratings.filter((rating) => {
