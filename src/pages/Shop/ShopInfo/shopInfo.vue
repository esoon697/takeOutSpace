<template>
  <div class="shop-info" ref="shopInfo">
      ...
      <section class="section">
        ...
        <div class="pic-wrapper">
          <ul class="pic-list" ref="picsList">
            <li class="pic-item" v-for="(pic, index) in info.pics" :key="index" @click="showLargeImg(pic)">
    ...
    <div class="largeImg-wrapper" v-show="isShowImg">
      <img :src="pic">
      <div class="bg" @click="changeLargeImg"></div>
    </div>
  </div>
</template>
  ...
  mounted () {
    this.$store.dispatch('reqShopInfo', () => {
      this.$nextTick(() => {
        ...
        const picsList = this.$refs.picsList
        const liWidth = 120
        const space = 6
        const count = this.info.pics.length
        picsList.style.width = (liWidth + space) * count - space + 'px'
